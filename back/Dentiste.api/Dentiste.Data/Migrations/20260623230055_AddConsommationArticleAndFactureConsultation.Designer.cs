...
namespace Dentiste.Data.Migrations
{
    ...
    [Migration("20260623230055_AddConsommationArticleAndFactureConsultation")]
    partial class AddConsommationArticleAndFactureConsultation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dentiste.Data.Models.CabinetDao", b =>
                {
                    ...
                    b.Property<string>("CloudinaryFolder")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("CAB_CLOUDINARY_FOLDER");
